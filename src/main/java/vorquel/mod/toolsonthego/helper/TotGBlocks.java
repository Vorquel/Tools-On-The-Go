...
import vorquel.mod.toolsonthego.block.*;
...
public class TotGBlocks {
    ...
    public static final Block plankStone = new BlockTotG(Material.rock).setHardness(2).setUnlocalizedName(MOD_ID + ".plankStone");
    public static final Block plankNRack = new BlockTotG(Material.rock).setHardness(2).setUnlocalizedName(MOD_ID + ".plankNetherrack");
    public static final Block craftingTableStone = new BlockTotGWorkbench().setHardness(2.5f).setUnlocalizedName(MOD_ID + ".workbenchStone");
    public static final Block craftingTableNRack = new BlockTotGWorkbench().setHardness(2.5f).setUnlocalizedName(MOD_ID + ".workbenchNetherrack");
    public static final Block ladderStone = new BlockTotGLadder().setHardness(0.4F).setUnlocalizedName(MOD_ID + ".ladderStone");
    public static final Block ladderNRack = new BlockTotGLadder().setHardness(0.4F).setUnlocalizedName(MOD_ID + ".ladderNetherrack");
