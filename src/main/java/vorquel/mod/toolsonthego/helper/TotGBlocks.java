...
public class TotGBlocks {
    ...
    public static final Block plankStone = new Block(Material.rock).setUnlocalizedName(MOD_ID + ".plankStone").setCreativeTab(CreativeTabs.tabBlock).setHardness(2).setStepSound(soundTypePiston);
    public static final Block plankNetherrack = new Block(Material.rock).setUnlocalizedName(MOD_ID + ".plankNetherrack").setCreativeTab(CreativeTabs.tabBlock).setHardness(2).setStepSound(soundTypePiston);
    ...
    public static void init() {
        ...
        proxy.registerBlock(craftingTableNetherrack, "crafting_table_netherrack");
    }
}
